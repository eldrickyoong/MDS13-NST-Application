...
function loadStyleThumbnails() {
  ...
  // Static path to your predefined styles
...
function checkImagesReady() {
  const contentReady = document.getElementById("content-box").classList.contains("has-image");
  const styleReady = document.getElementById("style-box").classList.contains("has-image");
...
function saveToGallery() {
  ...
  alert("✅ Image saved to your gallery (placeholder — integrate backend save later).");
}
